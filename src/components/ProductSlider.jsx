...
const ProductSlider = () => {
    ...
    return (
        <section className="product-section">
            ...
            <Slider {...settings}>
                <div><img src={Produk1} alt="Produk 1" /></div>
                <div><img src={Produk2} alt="Produk 2" /></div>
                <div><img src={Produk3} alt="Produk 3" /></div>
                <div><img src={Produk4} alt="Produk 4" /></div>
                <div><img src={Produk5} alt="Produk 5" /></div>
                <div><img src={Produk6} alt="Produk 6" /></div>
            </Slider>
        </section>
    );
};
